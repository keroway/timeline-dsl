...
export const GALLERY_EXAMPLES: GalleryExample[] = [
  ...
  },
  {
    label: '日本史年表（奈良〜江戸）',
    description:
      '複数 lane による時代区分・span/event/event_range と静的 item id を例示',
  ...
  },
  {
    label: '近代戦争年表',
    description:
      '多軸 lane と月日精度の event_range（1939-09-01..1945-09-02）を例示',
  ...
  },
  {
    label: '科学技術の発明・発見年表',
    description:
      '発明・発見・通信・計算機の4 lane と多数の event item id を例示',
  ...
  },
  {
    label: '架空帝国年表（フィクション）',
    description:
      '架空の王国・出来事、CSV（fictional_empire_items.csv）連携導線、color_map を例示',
  ...
  },
  {
    label: '中国王朝年表（グループ版）',
    description:
      'group ブロックによる lane グルーピングとグループ外 lane の混在を例示',
  ...
  },
  {
    ...
    description:
      '複数 lane（Web / プラットフォーム / SNS）と span/event 混在を例示',
  ...
  },
  {
    ...
    description:
      '月日精度の日付（1969-07-16 など）と短期ミッション span を例示',
  ...
  },
  {
    ...
    description:
      'CLI専用・構文参考: import ブロックで Wikidata エンティティを取得し span にマッピング',
  ...
  },
  {
    ...
    description:
      'CLI専用・構文参考: P569/P570 で人物の生没年を span にマッピング',
  ...
  },
  {
    ...
    description:
      'CLI専用・構文参考: SPARQL query と filter 句で複数 entity import を例示',
  ...
  },
  {
    ...
    description:
      'CLI専用・構文参考: template/apply と policy field_priority による再利用マッピングを例示',
  ...
  },
  {
    ...
    description:
      'CLI専用・構文参考: expand claim(P39) と qualifier(P580/P582) の event_range マッピングを例示',
  ...
  },
  {
    ...
    description:
      'block_options（note / link / color）と open-ended `now` の使用例を静的定義で例示',
  ...
  },
  {
    ...
    description:
      'unit second と UTC(`Z`)オフセット付き時刻値による秒精度タイムラインを例示',
  ...
  },
  {
    ...
    description:
      '複数タイムゾーン（+09:00 / -05:00 / Z）を使ったoffset付き値同士のUTC正規化比較を例示',
