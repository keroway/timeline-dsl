...
//!
//! 現バージョンの機能範囲: Diagnostics + Completion + Hover + Goto Definition + Code Action + Document Symbols + Find References + Rename + Formatting。
//!
...
//! - `textDocument/formatting`: DSL ソースを正準形（2 スペースインデント・ブロック間空行 1 行）に整形
